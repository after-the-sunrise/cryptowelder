...
VALUES ('binance', 'BTCUSDT', 'BTC', 'USD', 'BNC BTC', NULL),
       ...
       ('gmocoin', 'BTC_JPY', 'BTC', 'JPY', 'GMO BTC', NULL),
       ('huobijp', 'btcjpy', 'BTC', 'JPY', 'HBJ BTC', NULL),
...
VALUES ('binance', 'USD', 'oanda', 'USD_JPY', NULL, NULL),
       ...
       ('gmocoin', 'JPY', NULL, NULL, NULL, NULL),
       ('gmocoin', 'BTC', 'gmocoin', 'BTC_JPY', NULL, NULL),
       ('huobijp', 'JPY', NULL, NULL, NULL, NULL),
       ('huobijp', 'BTC', 'huobijp', 'btcjpy', NULL, NULL),
...
VALUES ('binance', 'CASH', 'USD', 'BNC USD'),
       ...
       ('gmocoin', 'FUND', 'JPY', 'GMO JPYF'),
       ('gmocoin', 'CASH', 'JPY', 'GMO JPY'),
       ('gmocoin', 'CASH', 'BTC', 'GMO BTC'),
       ('huobijp', 'FUND', 'JPY', 'HBJ JPYF'),
       ('huobijp', 'CASH', 'JPY', 'HBJ JPY'),
       ('huobijp', 'CASH', 'BTC', 'HBJ BTC'),
