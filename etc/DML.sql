...
VALUES ('binance', 'BTCUSDT', 'BTC', 'USD', 'BNC BTC', NULL),
       ...
       ('kucoin', 'BTC-USDT', 'BTC', 'USD', 'KCN BTC', NULL),
...
VALUES ('binance', 'USD', 'oanda', 'USD_JPY', NULL, NULL),
       ...
       ('kucoin', 'USD', 'oanda', 'USD_JPY', NULL, NULL),
       ('kucoin', 'BTC', 'bitflyer', 'BTC_JPY', NULL, NULL),
...
VALUES ('binance', 'CASH', 'USD', 'BNC USD'),
       ...
       ('kucoin', 'CASH', 'USD', 'KCN USD'),
       ('kucoin', 'CASH', 'BTC', 'KCN BTC'),
